...
public class User {
	...
	private String login_id,oldPassword,newPassword,confirmPassword;
	...
	public String getTableauPassword() {
		return tableauPassword;
	}
	public void setTableauPassword(String tableauPassword) {
		this.tableauPassword = tableauPassword;
	}

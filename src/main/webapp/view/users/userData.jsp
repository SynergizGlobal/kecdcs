...
<html lang="en">
  <head>
    ...
    <title>Document Upload</title>  <link href="/kecdcs/resources/css/critical.min.css" rel='stylesheet' type='text/css'>
    ...
    <!-- Datatables -->
	    ...
	    <!-- <link href="/kecdcs/resources/js/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css" rel="stylesheet"> --><!-- <link rel="stylesheet" href="/kecdcs/resources/css/darkmode.css"> -->
	  <!-- <link href="/kecdcs/resources/css/jquery.datetimepicker.css" rel="stylesheet"> -->
...
<!-- ------------------table data ------------------------------------------------------------------------------------>
   ...
   <%--  <jsp:include page="../layout/bottomNav.jsp"></jsp:include> --%>
    ...
    <script src=" /kecdcs/resources/js/jquery.datetimepicker.full.min.js"></script>
